...
function Defs() {
  return (
    <defs>
      <filter id="wf-fa-sk">
        <feTurbulence type="turbulence" baseFrequency="0.018" numOctaves="3" seed="3" result="noise"/>
        <feDisplacementMap in="SourceGraphic" in2="noise" scale="1.8" xChannelSelector="R" yChannelSelector="G"/>
      </filter>
      <pattern id="wf-fa-grid" width="24" height="24" patternUnits="userSpaceOnUse">
        <path d="M24 0L0 0 0 24" fill="none" stroke="#ddd5c5" strokeWidth="0.5"/>
      </pattern>
      <pattern id="wf-fa-hatch" width="6" height="6" patternUnits="userSpaceOnUse" patternTransform="rotate(45)">
  ...
  return (
    <div className="w-full bg-[#fdf8f0]" style={{ fontFamily: "monospace" }}>
      <svg viewBox={`0 0 1280 ${totalH}`} className="w-full h-auto" xmlns="http://www.w3.org/2000/svg">
        ...
        <rect width="1280" height={totalH} fill="url(#wf-fa-grid)" opacity="0.7"/>
        <g filter="url(#wf-fa-sk)">
          {/* NAV */}
