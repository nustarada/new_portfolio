  ...
  return (
    <div className="w-full bg-[#fdf8f0]">
      <svg viewBox={`0 0 1280 ${TOTAL_H}`} className="w-full h-auto" xmlns="http://www.w3.org/2000/svg">
        <defs>
          <filter id="wf-fb-sk">
            <feTurbulence type="turbulence" baseFrequency="0.018" numOctaves="3" seed="6" result="n"/>
            <feDisplacementMap in="SourceGraphic" in2="n" scale="1.8" xChannelSelector="R" yChannelSelector="G"/>
          </filter>
          <pattern id="wf-fb-grid" width="24" height="24" patternUnits="userSpaceOnUse">
            <path d="M24 0L0 0 0 24" fill="none" stroke="#ddd5c5" strokeWidth="0.5"/>
          </pattern>
          <pattern id="wf-fb-hatch" width="6" height="6" patternUnits="userSpaceOnUse" patternTransform="rotate(45)">
            <line x1="0" y1="0" x2="0" y2="6" stroke="#9ca3af" strokeWidth="0.9" opacity="0.55"/>
          </pattern>
        </defs>
        <rect width="1280" height={TOTAL_H} fill="#fdf8f0"/>
        <rect width="1280" height={TOTAL_H} fill="url(#wf-fb-grid)" opacity="0.65"/>
        <g filter="url(#wf-fb-sk)">
          {/* LEFT NAV */}
          ...
          <rect x={COL_X+16} y={14} width={320} height={18} rx="1" fill="#c8c4bc" opacity="0.8"/>
          <Ln x={COL_X+16} y={38} w={200} op={0.6}/>
