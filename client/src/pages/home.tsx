    ...
    <div className="min-h-screen bg-background text-foreground relative overflow-hidden" style={{ backgroundColor: '#040406', color: '#fafafa' }}>
      ...
      >
        ...
        <div className="absolute inset-0 pointer-events-none z-[1]">
          ...
          <div className="absolute bottom-8 left-6 md:bottom-12 md:left-12 w-8 h-8 md:w-12 md:h-12 border-l border-b border-primary/40" />
          <div className="absolute bottom-8 right-6 md:bottom-12 md:right-12 w-8 h-8 md:w-12 md:h-12 border-r border-b border-primary/40" />
        </div>
