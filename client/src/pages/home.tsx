        ...
        <div className="max-w-5xl mx-auto px-8 md:px-6 text-center relative z-20 w-full">
          ...
          >
            <h1 className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl xl:text-8xl font-semibold text-white tracking-wide leading-tight hero-text-hover flex justify-center">
              <span className="text-gray-200 druk-wide-medium blend-mode-overlay">
                KARN KALAA
              </span>
            </h1>
          ...
          >
            <h2 className="text-2xl md:text-3xl lg:text-4xl font-semibold leading-tight druk-wide-medium">
              ...
              <span className="text-primary font-light jost-secondary">
                {" "}
                & CREATIVE SOLUTIONS
              </span>
            </h2>
        ...
        <div className="max-w-4xl mx-auto px-6">
          ...
          <div className="text-center">
            <p className="text-white/70 text-sm font-light tracking-wider">
              © 2025 Karn Kalaa powered by pitchcraft.global. Designed &
