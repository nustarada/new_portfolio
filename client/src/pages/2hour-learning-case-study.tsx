            ...
            <div className="space-y-6">
              ...
              <div className="space-y-2">
                ...
                <h2 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-semibold text-white druk-wide-medium leading-tight">
                  Landing Page<br className="hidden sm:inline" /> Design System
                </h2>
              </div>
      ...
      <section id="designs" className="py-20 relative">
        ...
        <div className="max-w-7xl mx-auto px-6 relative z-10">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-16">
            ...
            >
              <Card 
                className="p-3 glass-card grain-texture border-cyan-500/30 hover:border-cyan-400/50 transition-all duration-500 cursor-pointer group"
              ...
              >
                ...
                <div className="text-center">
                  <h3 className="text-lg font-bold text-cyan-400 mb-1 druk-wide-medium">
                    Homepage (WordPress)
                  </h3>
                  <p className="text-white/75 text-xs jost-secondary">
                    Comprehensive overview targeting general audience
                  </p>
                </div>
              </Card>
            </motion.div>
            ...
            >
              <Card 
                className="p-3 glass-card grain-texture border-blue-500/30 hover:border-blue-400/50 transition-all duration-500 cursor-pointer group"
              ...
              >
                ...
                <div className="text-center">
                  <h3 className="text-lg font-bold text-blue-400 mb-1 druk-wide-medium">
                    Persona 1 (HubSpot)
                  </h3>
                  <p className="text-white/75 text-xs jost-secondary">
                    AI-powered learning targeting students
                  </p>
                </div>
              </Card>
            </motion.div>
            ...
            >
              <Card 
                className="p-3 glass-card grain-texture border-green-500/30 hover:border-green-400/50 transition-all duration-500 cursor-pointer group"
              ...
              >
                ...
                <div className="text-center">
                  <h3 className="text-lg font-bold text-green-400 mb-1 druk-wide-medium">
                    Persona 2 (HubSpot)
                  </h3>
                  <p className="text-white/75 text-xs jost-secondary">
            ...
            >
              <Card 
                className="p-3 glass-card grain-texture border-purple-500/30 hover:border-purple-400/50 transition-all duration-500 cursor-pointer group"
              ...
              >
                ...
                <div className="text-center">
                  <h3 className="text-lg font-bold text-purple-400 mb-1 druk-wide-medium">
                    Persona 3 (HubSpot)
                  </h3>
                  <p className="text-white/75 text-xs jost-secondary">
                    Revolutionary school model for institutions
                  </p>
                </div>
              </Card>
            </motion.div>
        ...
        <div className="max-w-6xl mx-auto px-6 relative z-10">
          ...
          >
            <Card className="p-12 glass-card grain-texture border-purple-500/30">
              ...
              <h3 className="text-2xl font-bold mb-6 text-purple-400 druk-wide-medium">KEY APPROACHES</h3>
            ...
            {caseStudyData.personas.map((persona, index) => (
              ...
              >
                <Card className="p-8 glass-card grain-texture border-green-500/30 h-full">
                  <h3 className="text-xl font-bold mb-4 text-green-300 druk-wide-medium">
                    {persona.title}
                  </h3>
            ...
            {caseStudyData.results.map((result, index) => (
              ...
              >
                <Card className="p-8 glass-card grain-texture border-orange-500/30 text-center h-full flex flex-col justify-between">
                  <div>
                    <div className="text-4xl font-bold text-orange-400 mb-2 druk-wide-medium">
                      {result.value}
                    </div>
        ...
        <div className="max-w-6xl mx-auto px-6 relative z-10">
          ...
          >
            <Card className="p-12 glass-card grain-texture border-primary/30">
              <h3 className="text-3xl font-bold mb-6 text-white druk-wide-medium">
