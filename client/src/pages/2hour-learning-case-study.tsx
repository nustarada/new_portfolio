...
export default function TwoHourLearningCaseStudy() {
  ...
  return (
    <div ref={containerRef} className="min-h-screen bg-[#090910] text-white twohr-case-study lg:pl-[208px]">
      <div className="lg:hidden"><CaseStudyNavigation sections={navSections} /></div>
      <CaseStudySidebar
        sections={navSections}
        accentColor="#a78bfa"
        projectTitle="2 Hour Learning"
        projectTag="Web · B2B EdTech"
        meta={[
          { label: "Role",     value: "Lead Designer" },
          { label: "Pages",    value: "4 — 1 WordPress + 3 HubSpot" },
          { label: "Platform", value: "Web (B2B)" },
          { label: "Tools",    value: "Figma · WordPress · HubSpot" },
        ]}
        progress={progress}
      />
