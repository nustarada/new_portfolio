    ...
    <div ref={containerRef} className="min-h-screen bg-background text-foreground relative grain-texture liffo-case-study">
      ...
      <section id="approach" className="py-20 relative">
        ...
        <div className="max-w-6xl mx-auto px-6 relative z-10">
          ...
          <motion.div
            ...
            className="mt-16"
          >
            <h3 className="text-4xl md:text-5xl font-semibold mb-8 text-center text-purple-300 modern-heritage">
              DESIGN PROCESS
            </h3>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
      ...
      <section id="screens" className="py-20 relative">
        ...
        <div className="max-w-7xl mx-auto px-6 relative z-10">
          ...
          >
            <Card className="p-8 glass-card grain-texture border-purple-500/30">
              <h3 className="text-4xl md:text-5xl font-semibold mb-6 text-purple-400 modern-heritage text-center">
                COMPLETE INTERFACE GALLERY
              </h3>
        ...
        <div className="max-w-6xl mx-auto px-6 relative z-10">
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 gap-6">
            {caseStudyData.results.map((result, index) => (
              ...
              >
                <Card className="p-6 text-center glass-card grain-texture border-green-500/30 hover:border-green-400/50 transition-all duration-300 h-56 flex flex-col">
                  <div className="text-3xl md:text-4xl font-black text-green-400 mb-3 modern-heritage">
                    {result.value}
                  </div>
                  <h3 className="text-lg font-semibold text-white mb-4 jost-secondary">
                    {result.metric}
                  </h3>
                  <p className="text-white/70 text-sm leading-relaxed jost-secondary flex-1 flex items-center">
                    {result.description}
                  </p>
                </Card>
              </motion.div>
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-6">
            {caseStudyData.techSpecs.map((tech, index) => (
              <motion.div
                ...
                whileHover={{ scale: 1.05, y: -5 }}
              >
                <Card className="p-6 text-center glass-card grain-texture border-blue-500/30 hover:border-blue-400/50 transition-all duration-300 h-40 flex flex-col justify-between">
