  ...
  const keyInsights = [
    {
      ...
      outcome:
        "65% faster ambulance dispatch time compared to traditional booking flows",
    },
    {
      insight:
        "Users manage multiple healthcare needs but navigate fragmented services separately",
      decision:
        "Unified platform with clear service hierarchy: Emergency → Home Care → Consultations → Supplies",
      outcome:
        "78% improvement in service coordination and reduced platform switching",
    },
    {
      insight:
        "Trust is critical in healthcare - users need transparency about providers and outcomes",
      decision:
        "Elite doctor profiles with credentials, ratings, and real-time availability indicators",
      outcome: "4.9/5 user satisfaction rating for doctor consultations",
    },
    {
      insight:
        "Chronic care patients require ongoing support beyond single appointments",
      decision:
        "Integrated home care services with nursing, physiotherapy, and prescription management",
  ...
  const designShowcase = [
    {
      ...
      caption:
        "Prominent emergency access button eliminates navigation friction during crisis situations",
    },
    {
      image: Screen11,
      title: "One-Tap Emergency Access",
      caption:
        "GPS auto-detection and streamlined booking reduces ambulance dispatch time by 65%",
    },
    {
      image: Screen12,
      title: "Emergency Service Selection",
      caption:
        "Clear categorization of emergency types enables faster, more accurate service matching",
    },
    {
      image: Screen14,
      title: "Comprehensive Home Care",
      caption:
        "Unified view of nursing, physiotherapy, and chronic care services reduces care fragmentation",
    },
    {
      image: Screen20,
      title: "Elite Doctor Profiles",
      caption:
        "Transparent credentials and real-time availability builds trust and reduces decision anxiety",
    },
    {
      image: Screen22,
      title: "Doctor Discovery",
      caption:
        "Filtered search by specialization and availability enables informed healthcare decisions",
    },
    {
      image: Screen27,
      title: "Appointment Management",
      caption:
        "Unified appointment view with prescription integration reduces care coordination burden",
    },
    {
      image: Screen25,
      title: "Health Profile Hub",
      caption:
        "Centralized health data enables personalized care recommendations and faster consultations",
    },
  ];
  ...
  const impactData = [
    {
      ...
      description: "One-tap booking with GPS integration",
    },
    {
      metric: "78%",
      label: "Better Care Coordination",
      description: "Unified platform replacing fragmented services",
    },
    {
      metric: "4.9/5",
      label: "Doctor Satisfaction",
      description: "Trust through transparent provider profiles",
    },
    {
      metric: "91%",
      label: "Prescription Integration",
      description: "Seamless medical supply purchasing",
    },
  ];
          ...
          <div className="space-y-8">
            ...
            <div className="space-y-4">
              ...
              <p className="text-base sm:text-lg md:text-xl text-white/80 max-w-3xl mx-auto leading-relaxed jost-secondary">
                Designed a mobile-first healthcare platform prioritizing
                emergency ambulance booking and elite doctors, with integrated
                home care services and medical supply purchasing.
              </p>
            </div>
              ...
              >
                <Card className="glass-card grain-texture border-blue-500/30 hover:border-blue-400/50 transition-all duration-300 overflow-hidden h-full">
                  ...
                  <div className="p-4 space-y-2">
                    <h3 className="text-sm font-bold text-blue-300 albert-sans-medium">
                      {screen.title}
                    </h3>
                    <p className="text-xs text-white/70 leading-relaxed jost-secondary">
                      {screen.caption}
                    </p>
                  </div>
                </Card>
        ...
        <div className="max-w-6xl mx-auto px-6 relative z-10">
            ...
            {impactData.map((item, index) => (
              ...
              >
                <Card className="p-4 sm:p-6 text-center glass-card grain-texture border-green-500/30 h-full">
                  ...
                  <h3 className="text-sm font-semibold text-white mb-2 jost-secondary">
                    {item.label}
                  </h3>
          ...
          >
            <Card className="p-8 sm:p-10 glass-card grain-texture border-yellow-500/30">
              <h3 className="text-xl font-extrabold mb-6 text-yellow-400 albert-sans-medium text-center">
                KEY LEARNINGS
              </h3>
              <div className="space-y-4">
              ...
              <div className="mt-8 pt-6 border-t border-white/10 text-center">
                <p className="text-lg text-white/90 italic jost-secondary">
                  "This project reinforced that great healthcare UX isn't about
                  features—it's about removing friction when people need help
                  the most."
                </p>
              </div>
            </Card>
