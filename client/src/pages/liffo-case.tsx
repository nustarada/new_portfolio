    ...
    <div ref={containerRef} className="min-h-screen bg-background text-foreground relative grain-texture liffo-case-study">
          ...
          <div className="space-y-8">
            ...
            <div className="space-y-4">
              ...
              <h1 className="space-y-2">
                <span className="block text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-semibold text-white druk-wide-medium leading-tight">Liffo</span>
                <span className="block text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-semibold bg-gradient-to-r from-red-400 via-orange-400 to-yellow-400 bg-clip-text text-transparent druk-wide-medium leading-tight">Emergency Health<br className="hidden sm:inline" /> Platform</span>
              </h1>
        ...
        <div className="max-w-6xl mx-auto px-6 relative z-10">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 mb-16">
            ...
            >
              <Card className="p-8 glass-card grain-texture border-red-500/30 h-full flex flex-col">
                <h3 className="text-2xl font-bold mb-6 text-red-400 druk-wide-medium">PROJECT DETAILS</h3>
            ...
            >
              <Card className="p-8 glass-card grain-texture border-orange-500/30 h-full flex flex-col">
                <h3 className="text-2xl font-bold mb-6 text-orange-400 druk-wide-medium">OVERVIEW</h3>
          ...
          >
            <Card className="p-6 sm:p-8 lg:p-12 glass-card grain-texture border-red-500/30">
              <h3 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-semibold mb-6 sm:mb-8 text-center text-red-400 druk-wide-medium">THE HEALTHCARE CHALLENGE</h3>
              <p className="text-xl text-white/90 leading-relaxed mb-8 jost-secondary">
                {caseStudyData.problem.description}
              </p>
              
              <h4 className="text-2xl font-bold mb-6 text-red-400 druk-wide-medium">KEY PAIN POINTS</h4>
                  ...
                  <div className="space-y-4 sm:space-y-6">
                    <div className="flex flex-col sm:flex-row sm:items-center space-y-3 sm:space-y-0 sm:space-x-4">
                      ...
                      <div className="text-center sm:text-left">
                        <h3 className="text-lg sm:text-xl font-bold text-blue-300 druk-wide-medium leading-tight">{persona.name}</h3>
                  ...
                  <div className="grid grid-cols-1 lg:grid-cols-4 gap-6">
                    <div className="lg:col-span-1">
                      <div className="flex items-center space-x-3 mb-4">
                        ...
                        <h3 className="text-lg font-bold text-purple-300 druk-wide-medium">{phase.phase}</h3>
                      </div>
                    </div>
        ...
        <div className="max-w-6xl mx-auto px-6 relative z-10">
          ...
          >
            <Card className="p-12 glass-card grain-texture border-green-500/30">
              ...
              <h3 className="text-2xl font-bold mb-6 text-green-400 druk-wide-medium">SOLUTION FEATURES</h3>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          ...
          <motion.div
            ...
            className="mt-16"
          >
            <h3 className="text-4xl md:text-5xl font-semibold mb-8 text-center text-purple-300 druk-wide-medium">
              DESIGN PROCESS
            </h3>
              ...
              {caseStudyData.process.map((phase, index) => (
                ...
                >
                  <Card className="p-6 glass-card grain-texture border-purple-500/30 h-full">
                    ...
                    <h4 className="text-xl font-bold mb-4 text-purple-300 druk-wide-medium">
                      {phase.phase}
                    </h4>
            ...
            {caseStudyData.keyFeatures.map((feature, index) => (
              ...
              >
                <Card className="p-8 glass-card grain-texture border-orange-500/30 h-full">
                  ...
                  <h3 className="text-xl font-bold mb-4 text-orange-300 druk-wide-medium">
                    {feature.title}
                  </h3>
      ...
      <section id="screens" className="py-20 relative">
        ...
        <div className="max-w-7xl mx-auto px-6 relative z-10">
            ...
            {caseStudyData.designShowcase.map((showcase, index) => (
              ...
              >
                <Card className="p-8 glass-card grain-texture border-blue-500/30">
                  <h3 className="text-2xl font-bold mb-4 text-blue-400 druk-wide-medium">
                    {showcase.category}
                  </h3>
          ...
          >
            <Card className="p-8 glass-card grain-texture border-purple-500/30">
              <h3 className="text-4xl md:text-5xl font-semibold mb-6 text-purple-400 druk-wide-medium text-center">
                COMPLETE INTERFACE GALLERY
              </h3>
                ...
                >
                  <Card className="p-8 glass-card grain-texture border-cyan-500/30 h-full">
                    <div className="flex items-start space-x-4">
                      ...
                      <div>
                        <h3 className="text-xl font-bold text-cyan-300 mb-3 druk-wide-medium">
                          {principle.principle}
                        </h3>
      ...
      <section className="py-20 relative">
        ...
        <div className="max-w-4xl mx-auto px-6 text-center relative z-10">
          <motion.div
            ...
            className="space-y-8"
          >
            <h2 className="text-4xl md:text-5xl font-semibold druk-wide-medium text-white">
